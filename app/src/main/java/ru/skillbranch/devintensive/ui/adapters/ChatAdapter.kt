...
class ChatAdapter(val listener: (ChatItem) -> Unit) : RecyclerView.Adapter<ChatAdapter.ChatItemViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ChatItemViewHolder {
        ...
        return when(viewType) {
            ARCHIVE_TYPE -> SingleViewHolder(inflater.inflate(R.layout.item_chat_single, parent, false))
...
//        return SingleViewHolder(convertView)
    ...
    abstract inner class ChatItemViewHolder(convertedView: View) : RecyclerView.ViewHolder(convertedView), LayoutContainer {
    ...
    inner class SingleViewHolder(convertedView: View) : ChatItemViewHolder(convertedView), ChatItemTouchHelperCallback.ItemTouchViewHolder {
...
//                iv_avatar_single.setInitials(item.initials)
    ...
    inner class GroupViewHolder(convertedView: View) : ChatItemViewHolder(convertedView), ChatItemTouchHelperCallback.ItemTouchViewHolder {
        override fun onItemSelected() {
            itemView.setBackgroundColor(Color.LTGRAY)
        }
